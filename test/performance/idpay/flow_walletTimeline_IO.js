...
import { getWallet, getWalletDetail } from "../../common/api/walletClient.js";
...
export const options = {
  ...
  scenarios: { flow_walletTimeline_IO: scenarioConfig },
...
const getWalletDetailOk_Counter = new Counter("_getWalletDetail_ok");
const getWalletDetailKo_Counter = new Counter("_getWalletDetail_ko");
const getTimelineOk_Counter = new Counter("_getTimeline_ok");
const getTimelineKo_Counter = new Counter("_getTimeline_ko");
...
export default function () {
  ...
  callAndTrack(
    ...
    getWalletDetailOk_Counter,
    getWalletDetailKo_Counter,
    "✅ getWalletDetail",
  ...
  callAndTrack(
    getTimeline,
    [baseUrl, token, INITIATIVE_ID],
    getTimelineOk_Counter,
    getTimelineKo_Counter,
    "✅ getTimeline",
    ["TIMELINE_USER_NOT_FOUND"]
  );
}
// ./k6 run -e K6PERF_SCENARIO_TYPE="constant-arrival-rate" -e K6PERF_TIME_UNIT="1s" -e K6PERF_PRE_ALLOCATED_VUS="10" -e K6PERF_MAX_VUS="20" -e K6PERF_RATE="1" -e K6PERF_DURATION="1s" -e TARGET_ENV="uat" -e FISCAL_CODE_FILE="../../../assets/fc_list_100k.csv" -e INITIATIVE_ID="68de7fc681ce9e35a476e985" .\test\performance\idpay\flow_walletTimeline_IO.js
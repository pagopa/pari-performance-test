...
export default function () {
  ...
  group('Wallet API → get Wallet Detail', () => {
    const res = getWalletDetail(baseUrl, token, INITIATIVE_ID, 'it-IT', EXPECTED_STATUSES);
...
// ./k6 run -e K6PERF_SCENARIO_TYPE="constant-arrival-rate" -e K6PERF_TIME_UNIT="1s" -e K6PERF_PRE_ALLOCATED_VUS="10" -e K6PERF_MAX_VUS="20" -e K6PERF_RATE="1" -e K6PERF_DURATION="1s" -e TARGET_ENV="uat" -e FISCAL_CODE_FILE="../../../assets/fc_list_100k.csv" -e INITIATIVE_ID="68de7fc681ce9e35a476e985" -e EXPECTED_STATUSES="200,404" .\test\performance\idpay\getWalletDetail.js